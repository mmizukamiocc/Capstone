...
class DBHelper extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "GamesToRate";
    ...
    private static final String FIELD_IMAGE_NAME = "imageName";
    ...
    public void addGame(Game game) {
        ...
        values.put(FIELD_DESCRIPTION, game.getDescription()); // task name
